            ...
            <div class="row catg font-weight-bold" style="direction: rtl; border: none; margin-top: 10px; margin-bottom: 10px">
                <table border="1" style="border: 1px solid; border-collapse: collapse; width: 100%; margin-bottom: 4px;">
                    <tr>
                        ...
                        <td class="chkboxlbltd" style="padding-top: 4px;padding-bottom: 4px;">وكيل شحن بحري
                        <br />
 ...
 <tr>
                                            ...
                                            <td rowspan="2">
                                                <div style="margin-top: 14px;">
                                                    ...
                                                    <input type="checkbox" class="form-check text-center TbleChecboxes" id="Update" <% if (drUser["Updated"].ToString() == "True") { %> checked="" <%}   %>/>
                                            ...
                                            <td rowspan="2">
                                                <div style="margin-top: 14px;">
                                                    <input type="checkbox" class="form-check text-center TbleChecboxes" id="NewCHK" <% if (drUser["New"].ToString() == "True") { %> checked="" <%}   %>/>
                                                </div>
                                            </td>
                                            <td rowspan="2" class="text-center">
                                                <div style="margin-top: 14px;"><%= (i+1) %></div>
                                            </td>
                                        </tr>
                                        <tr>
